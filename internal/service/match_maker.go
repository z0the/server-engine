...
func NewMatchMakerService(logger *logrus.Logger, msgPipe chan<- hubber.IResponse) *MatchMakerService {
...
func (s *MatchMakerService) JoinRoom(ownerID int64, data RoomData) (int64, error) {
	s.Lock()
	defer s.Unlock()
...
func (s *MatchMakerService) SendToGame(roomID int64, req hubber.IRequest) error {
...
func (s *MatchMakerService) validateRoomData(data RoomData) RoomData {
...
func (s *MatchMakerService) createRoom(data RoomData) *Room {
	s.lastID++
	newRoom := &Room{
		msgPipe:  s.msgPipe,
		logger:   s.logger,
...
func (s *MatchMakerService) findAppropriateRoom(data RoomData) *Room {
...
func (r *Room) handleRequest(req hubber.IRequest) error {
	if r.Game != nil {
